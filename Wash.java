 ...
 */
public class Wash implements ActionListener {
    ...
    JLabel lbtitle = new JLabel("#------HSV Laundry Clothes Dept------#");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == btndone) {
            try {
                ...
                String sss = "UPDATE order1 set status='DONE' where token=" + x + " AND (type='wf' OR type='wi') AND status='pending'";
